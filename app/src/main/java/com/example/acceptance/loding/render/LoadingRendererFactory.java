package com.example.acceptance.loding.render;

import android.content.Context;
import android.util.SparseArray;

import com.example.acceptance.loding.render.animal.FishLoadingRenderer;
import com.example.acceptance.loding.render.animal.GhostsEyeLoadingRenderer;
import com.example.acceptance.loding.render.circle.jump.CollisionLoadingRenderer;
import com.example.acceptance.loding.render.circle.jump.DanceLoadingRenderer;
import com.example.acceptance.loding.render.circle.jump.GuardLoadingRenderer;
import com.example.acceptance.loding.render.circle.jump.SwapLoadingRenderer;
import com.example.acceptance.loding.render.circle.rotate.GearLoadingRenderer;
import com.example.acceptance.loding.render.circle.rotate.LevelLoadingRenderer;
import com.example.acceptance.loding.render.circle.rotate.MaterialLoadingRenderer;
import com.example.acceptance.loding.render.circle.rotate.WhorlLoadingRenderer;
import com.example.acceptance.loding.render.goods.BalloonLoadingRenderer;
import com.example.acceptance.loding.render.goods.WaterBottleLoadingRenderer;
import com.example.acceptance.loding.render.scenery.DayNightLoadingRenderer;
import com.example.acceptance.loding.render.scenery.ElectricFanLoadingRenderer;
import com.example.acceptance.loding.render.shapechange.CircleBroodLoadingRenderer;
import com.example.acceptance.loding.render.shapechange.CoolWaitLoadingRenderer;
