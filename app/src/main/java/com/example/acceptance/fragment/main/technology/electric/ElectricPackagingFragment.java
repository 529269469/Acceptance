...
import com.example.acceptance.fragment.main.technology.electric.packaging.Packaging1Fragment;
import com.example.acceptance.fragment.main.technology.electric.packaging.Packaging2Fragment;
...
/**
 * 技术类检查——电气产品外观性能试验等检查——包装检查
 */
public class ElectricPackagingFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_electric_packaging;
    }
}
