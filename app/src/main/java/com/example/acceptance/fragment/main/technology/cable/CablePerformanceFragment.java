...
import com.example.acceptance.fragment.main.technology.cable.performance.Performance1Fragment;
import com.example.acceptance.fragment.main.technology.cable.performance.Performance2Fragment;
import com.example.acceptance.fragment.main.technology.cable.performance.Performance3Fragment;
...
/**
 * 技术类检查——电缆产品外观性能试验等检查——产品性能测试验收情况（常温）检查
 */
public class CablePerformanceFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_cable_performance;
    }
}
